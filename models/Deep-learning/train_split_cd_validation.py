...
def train_split_cd_validation(args):
    ...
    if args.regression:
        ...
        get_classification_metrics(model, val_dataset, fig, ax1, ax2, args.regression, args.kfold, args.split, args.guidelength, model_name=args.model + ':validation set', dataset_name=args.dataset, 
                                   save=False)
        get_classification_metrics_cd(model, test_dataset, fig, ax1, ax2, args.regression, args.kfold, args.split, args.guidelength, model_name=args.model + ':test set', dataset_name=args.dataset)
    ...
    if args.gradients:
        ...
        #integrated_gradients(model, unshuffled_train, args.regression, args.kfold, args.split, model_name=args.model, dataset_name=args.dataset)
...
if __name__ == '__main__':
    ...
    train_split_cd_validation(args)
