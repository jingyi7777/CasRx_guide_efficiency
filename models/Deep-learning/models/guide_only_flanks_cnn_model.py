...
def guide_only_flanks_cnn_model(args,num_strided_down=4,kernel=3,cnn_units=32, dense_units=8, recurrent_layers=1, noise=True):
    #seq = keras.Input(shape=(30, 4))
    seq = keras.Input(shape=(30+2*args.flanklength, 4))
