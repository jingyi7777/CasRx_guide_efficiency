...
def cnn_loo_pos_floats_guide_f24_filtered_1genef_9fold_top20gene_mfe_flanks_dg_linfo_contra_val_threepos_flags_isoref_dataset(args):
    ...
    #classes = dataframe['0.45ratio_good'].values
