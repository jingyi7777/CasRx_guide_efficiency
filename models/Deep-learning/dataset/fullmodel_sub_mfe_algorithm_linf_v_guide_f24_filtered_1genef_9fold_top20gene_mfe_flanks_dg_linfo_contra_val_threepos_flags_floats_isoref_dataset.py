...
def fullmodel_sub_mfe_algorithm_linf_v_guide_f24_filtered_1genef_9fold_top20gene_mfe_flanks_dg_linfo_contra_val_threepos_flags_floats_isoref_dataset(args):
    ...
    for ii in range(num_examples):
        ...
        linearfold_vals[ii] = abs(linearfold_vals[ii]+15.40)

    rnafe = dataframe['vienna_2_T37'].values
    ...
    #other_single_value_inputs[0, :] = rnafe_rel
    ...
    #other_single_value_inputs[4, :] = dataframe['RNAseq2_relative'].values
