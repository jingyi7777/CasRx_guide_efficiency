...
def cnn_loo_pos_flags_guide_f24_filtered_1genef_9fold_top20gene_mfe_flanks_dg_linfo_contra_val_threepos_flags_floats_dataset(args):
    ...
    other_single_value_inputs[2, :] = ddg
