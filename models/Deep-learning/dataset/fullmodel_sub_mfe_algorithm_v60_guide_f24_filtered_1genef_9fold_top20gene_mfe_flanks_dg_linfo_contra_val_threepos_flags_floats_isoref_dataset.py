...
def fullmodel_sub_mfe_algorithm_v60_guide_f24_filtered_1genef_9fold_top20gene_mfe_flanks_dg_linfo_contra_val_threepos_flags_floats_isoref_dataset(args):
    ...
    rnafe = dataframe['vienna_2_T60'].values
