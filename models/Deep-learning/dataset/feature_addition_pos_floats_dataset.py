...
def feature_addition_pos_floats_dataset(args):
    ...
    #other_single_value_inputs[0, :] = linearfold_dr
    ...
    #other_single_value_inputs[0, :] = dataframe['refseq_target_transcript_percent'].values
    #other_single_value_inputs[0, :] = ddg
    other_single_value_inputs[0, :] = dataframe['UTR5_position'].values
    other_single_value_inputs[1, :] = dataframe['CDS_position'].values
    other_single_value_inputs[2, :] = dataframe['UTR3_position'].values
