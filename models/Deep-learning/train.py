...
def train_model(args):
    ...
    if args.regression:
        get_regression_metrics(model, test_dataset, args.regression, args.kfold, args.split, model_name=args.model, dataset_name=args.dataset)
        ...
        get_classification_metrics(model, val_dataset, fig, ax1, ax2, args.regression, args.kfold, args.split, args.guidelength, model_name=args.model + ':validation set', dataset_name=args.dataset, 
                                   save=False)
        get_classification_metrics(model, test_dataset, fig, ax1, ax2, args.regression, args.kfold, args.split, args.guidelength, model_name=args.model + ':test set', dataset_name=args.dataset)
